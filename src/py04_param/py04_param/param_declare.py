...
class ParamNode(Node):
    ...
    def timer_callback(self):
        robot_name_param=self.get_parameter("robot_name").get_parameter_value().string_value #从ROS2系统当中读取参数的值，参数名为robot_name，获取参数对象后调用get_parameter_value()方法获取参数值对象，再调用string_value属性获取字符串类型的参数值
