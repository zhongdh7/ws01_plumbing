...
ROSIDL_GENERATOR_C_EXPORT
bool base_interfaces_demo__srv__addints__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.srv._addints.Addints_Event", full_classname_dest, 47) == 0);
  }
  ...
  {  // request
    ...
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!base_interfaces_demo__srv__addints__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!base_interfaces_demo__srv__addints__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * base_interfaces_demo__srv__addints__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = base_interfaces_demo__srv__addints__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = base_interfaces_demo__srv__addints__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
